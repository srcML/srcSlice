...
TEST_CASE( "Pass-By-Reference Test 20", "[srcslice]" ) {
    ...
    output = "{\n"
            ...
            "    \"dependentVariables\": [  ],\n"
            "    \"aliases\": [  ],\n"
            "    \"calledFunctions\": [ {\"functionName\": \"swap\", \"parameterNumber\": \"1\", \"definitionLine\": \"1\"} ],\n"
            "    \"use\": [ 1, 2, 9 ],\n"
            "    \"definition\": [ 3, 7 ]\n"
            "},\n"
            "\"slice_1\" : {\n"
            ...
            "    \"dependentVariables\": [  ],\n"
            "    \"aliases\": [  ],\n"
            "    \"calledFunctions\": [ {\"functionName\": \"swap\", \"parameterNumber\": \"2\", \"definitionLine\": \"1\"} ],\n"
            "    \"use\": [ 1, 3, 9 ],\n"
            "    \"definition\": [ 4, 8 ]\n"
            "},\n"
            "\"slice_2\" : {\n"
...
TEST_CASE( "Pass-By-Reference Test 21", "[srcslice]" ) {
    ...
    output = "{\n"
            ...
            "    \"dependentVariables\": [  ],\n"
            "    \"aliases\": [  ],\n"
            "    \"calledFunctions\": [ {\"functionName\": \"swap\", \"parameterNumber\": \"1\", \"definitionLine\": \"3\"} ],\n"
            "    \"use\": [ 3, 4, 11 ],\n"
            "    \"definition\": [ 5, 9 ]\n"
            "},\n"
            "\"slice_1\" : {\n"
            ...
            "    \"dependentVariables\": [  ],\n"
            "    \"aliases\": [  ],\n"
            "    \"calledFunctions\": [ {\"functionName\": \"swap\", \"parameterNumber\": \"2\", \"definitionLine\": \"3\"} ],\n"
            "    \"use\": [ 3, 5, 11 ],\n"
            "    \"definition\": [ 6, 10 ]\n"
            "},\n"
            "\"slice_2\" : {\n"
...
TEST_CASE( "Pass-By-Reference Test 22", "[srcslice]" ) {
    ...
    output = "{\n"
            ...
            "    \"dependentVariables\": [  ],\n"
            "    \"aliases\": [  ],\n"
            "    \"calledFunctions\": [ {\"functionName\": \"swap\", \"parameterNumber\": \"1\", \"definitionLine\": \"4\"} ],\n"
            "    \"use\": [ 4, 5, 12 ],\n"
            "    \"definition\": [ 6, 10 ]\n"
            "},\n"
            "\"slice_1\" : {\n"
            ...
            "    \"dependentVariables\": [  ],\n"
            "    \"aliases\": [  ],\n"
            "    \"calledFunctions\": [ {\"functionName\": \"swap\", \"parameterNumber\": \"2\", \"definitionLine\": \"4\"} ],\n"
            "    \"use\": [ 4, 6, 12 ],\n"
            "    \"definition\": [ 7, 11 ]\n"
            "},\n"
            "\"slice_2\" : {\n"
...
TEST_CASE( "Pass-By-Reference Test 23", "[srcslice]" ) {
    ...
    output = "{\n"
            ...
            "    \"dependentVariables\": [ { \"b\": 7 } ],\n"
            "    \"aliases\": [  ],\n"
            "    \"calledFunctions\": [ {\"functionName\": \"bar\", \"parameterNumber\": \"1\", \"definitionLine\": \"1\"} ],\n"
            "    \"use\": [ 1, 2, 7, 8 ],\n"
            "    \"definition\": [ 5 ]\n"
            "},\n"
            "\"slice_3\" : {\n"
...
TEST_CASE( "Pass-By-Reference Test 24", "[srcslice]" ) {
    sourceCode = "void bar(int& num) {\n"
                "    std::cout << num << std::endl;\n"
                "    num = 10;\n"
                "}\n"
    ...
    output = "{\n"
            ...
            "    \"dependentVariables\": [  ],\n"
            "    \"aliases\": [  ],\n"
            "    \"calledFunctions\": [ {\"functionName\": \"swap\", \"parameterNumber\": \"1\", \"definitionLine\": \"5\"} ],\n"
            "    \"use\": [ 5, 6, 14 ],\n"
            "    \"definition\": [ 7, 12 ]\n"
            "},\n"
            "\"slice_1\" : {\n"
            ...
            "    \"dependentVariables\": [  ],\n"
            "    \"aliases\": [  ],\n"
            "    \"calledFunctions\": [ {\"functionName\": \"swap\", \"parameterNumber\": \"2\", \"definitionLine\": \"5\"} ],\n"
            "    \"use\": [ 5, 7, 14 ],\n"
            "    \"definition\": [ 8, 13 ]\n"
            "},\n"
            "\"slice_2\" : {\n"
...
// bar becomes a pass-by-value function
TEST_CASE( "Pass-By-Reference Test 25", "[srcslice]" ) {
    sourceCode = "void bar(int num) {\n"
                "    std::cout << num << std::endl;\n"
                "}\n"
                "void swap(int& a, int& b) {\n"
...
TEST_CASE( "Pass-By-Reference Test 26", "[srcslice]" ) {
    sourceCode = "void bar(int num) {\n"
                "    std::cout << num << std::endl;\n"
                "    num = 10;\n"
                "}\n"
