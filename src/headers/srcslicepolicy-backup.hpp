...
public:
    ...
    SrcSlicePolicy(std::initializer_list<srcSAXEventDispatch::PolicyListener *> listeners = {})
...
private:
    ...
    void InitializeEventHandlers() {
        ...
        closeEventMap[ParserState::archive] = [this](srcSAXEventContext &ctx [[maybe_unused]]) {
